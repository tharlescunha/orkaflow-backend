    ...
    def _load_schedules(db: Session, automation_ids: list[int]) -> list[Schedule]:
        ranked_schedules = (
            select(
                ...
                func.row_number()
                .over(
                    partition_by=Schedule.automation_id,
                    order_by=(
            ...
            .where(Schedule.automation_id.in_(automation_ids))
            .subquery()
        )
        ...
        return (
            ...
            .join(
                ranked_schedules,
                Schedule.id == ranked_schedules.c.schedule_id,
            )
            .filter(ranked_schedules.c.row_number == 1)
            .all()
        )
    ...
    def _load_last_tasks(db: Session, automation_ids: list[int]) -> list[Task]:
        ranked_tasks = (
            select(
                ...
                func.row_number()
                .over(
                    partition_by=Task.automation_id,
                    order_by=(
            ...
            .where(Task.automation_id.in_(automation_ids))
            .subquery()
        )
        ...
        return (
            ...
            .join(
                ranked_tasks,
                Task.id == ranked_tasks.c.task_id,
            )
